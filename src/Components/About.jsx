...
const About = () => {
  return (
    ...
    >
      ...
      <div className="  m-auto  md:flex-row sm:flex-col bg-black shadow-md shadow-white  bg-gradient-to-r from-black to-gray-800">
        <div className="flex flex-col items-center justify-around w-[100%] py-6 lg:flex-row md:flex-row ">
          <div className="aboutimg w-[70%] lg:w-[40%] md:w-[40%] rounded-2xl ">
